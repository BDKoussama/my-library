  ...
  return (
    <div className="bg-indigo-darker text-center p-4 px-6 flex items-center">
        ...
        <div className="lg:hidden pr-3" id="mobile-nav-trigger">
            <div className="toggle p-2 block"><span></span></div>
        </div>
        <div className="flex flex-grow items-center lg:w-3/4 xl:w-4/5">
            ...
            <a href="#" className="text-sm text-right text-white py-2 px-3 hover:text-grey-dark no-underline hidden lg:block lg:w-1/3 px-6">Back to Codrops</a>
        </div>
    </div>
  )
}
